		...
		<table id="invoice_list" class="itemized_list">
			...
			<tr valign="top">
				...
				<td valign="top" class="name"><input class="item_name"
					...
					value="<?php if (isset($itemized_item[name])){ echo stripslashes($itemized_item[name]); } ?>" /></td>
				<td valign="top" class="description"><textarea style="height: 25px;"
					name="itemized_list[<?php echo $counter; ?>][description]"
					class="item_description autogrow"><?php if (isset($itemized_item[description])){ echo stripslashes($itemized_item[description]); } ?></textarea></td>
				<td valign="top" class="quantity"><input
					value="<?php if (isset($itemized_item[quantity])){ echo stripslashes($itemized_item[quantity]); } ?>"
				...
				<td valign="top" class="price"><input
					value="<?php if (isset($itemized_item[price])){ echo stripslashes($itemized_item[price]); } ?>"
...
<input type="hidden" name="rec_period"
	...
	value="<?php echo date('d/m/Y', strtotime($invoice->display('startDateM'))); ?>" /> <input
	type="hidden" name="rec_end_date"
	value="<?php echo date('d/m/Y', strtotime($invoice->display('endDateM'))); ?>" /> <input

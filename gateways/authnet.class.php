...
class Web_Invoice_Authnet
{
    ...
    public function __construct()
    {
        if (self::$instances == 0)
        {
			$this->url = stripslashes(get_option("web_invoice_gateway_url"));

            $this->params['x_delim_data']     = stripslashes(get_option("web_invoice_gateway_delim_data"));
            $this->params['x_delim_char']     = stripslashes(get_option("web_invoice_gateway_delim_char"));
            $this->params['x_encap_char']     = stripslashes(get_option("web_invoice_gateway_encap_char"));
            ...
            $this->params['x_login']          = stripslashes(get_option("web_invoice_gateway_username"));
            $this->params['x_tran_key']       = stripslashes(get_option("web_invoice_gateway_tran_key"));
            $this->params['x_test_request']   = stripslashes(get_option("web_invoice_gateway_test_mode"));
